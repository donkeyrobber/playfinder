...
class CreateSlotHydratorTest extends SlotHydratorTestCase
{

    public function testHydrateForCreate() {
        ...
        $hydrator = new CreateSlotHydrator($this->mock_entity_manager, $this->mock_exception_factory, $this->mock_uuid_generator);

        $slot = $hydrator->hydrateForCreate($this->mock_json_api_request, $this->mock_exception_factory, new Slot());
